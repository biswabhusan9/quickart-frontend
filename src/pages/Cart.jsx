...
const Cart = ({ location, getLocation }) => {
  ...
  useEffect(() => {
    if (location) {
      setAddress(location.road || location.neighbourhood || location.suburb || location.village || location.town || location.city || '')
          ...
          <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 md:gap-20'>
              <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
                ...
                <button className='bg-red-500 text-white px-3 py-1 rounded-md mt-3 cursor-pointer' onClick={handleConfirmOrder}>
                  Submit
                </button>
              ...
              <div className='bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max'>
                ...
                <div className='flex justify-between items-center'>
                  ...
                  <p className='text-red-500 font-semibold'>
                    <span className='text-gray-600 line-through px-1'>$5</span>FREE
                  </p>
                </div>
                <div className='flex justify-between items-center'>
                  <h1 className='flex gap-1 items-center text-gray-700'>
